...
COLUMNS_REMAPPING = {
    ...
    # 'player_tags':"",#player page
    # 'different_position_ratings':'' #player page
...
#     'Age':'age',
#     'dob':'dob', #need to go to player page
#     'height':'height_cm',
#     'club_contract_valid_until_year':'club_contract_valid_until_year'  #need to go to player page
# }